module.exports = {
    ...
    cdnThirdParty: {
        jquery: '/echarts4/cdn/jquery2.2.4.min.js',
        jquery_1_11_3: '/echarts4/cdn/jquery1.11.3.min.js',
        bootstrapCSS: '/echarts4/cdn/bootstrap.min.css',
        bootstrapJS: '/echarts4/cdn/bootstrap.min.js',
        lodash: '/echarts4/cdn/index.min.js',
        perfectScrollbarJS: '/echarts4/cdn/perfect-scrollbar.min.js',
        perfectScrollbarCSS: '/echarts4/cdn/perfect-scrollbar.min.css',
        paceProgressBarJS: '/echarts4/cdn/pace.min.js',
        sweetalertJS: '/echarts4/cdn/sweetalert.min.js',
        echartsMinJS_4_8_0: '/echarts4/cdn/echarts.min.js',
        prettifyJS: '/echarts4/cdn/prettify.min.js',
        // Can not find good prettify css in jsdelivr.
        // prettifyCSS: '/echarts4/cdn/doxy.css',
        prettifyCSSHandlerJS: '/echarts4/cdn/lang-css.js',
        jqueryLazyloadJS: '/echarts4/cdn/jquery.lazyload.min.js',

        // CDN for doc
        vueJS: '/echarts4/cdn/vue.min.js',
        elementUIJS: '/echarts4/cdn/index.js',
        elementUICSS: '/echarts4/cdn/index.css',
        codeMirrorJS: '/echarts4/cdn/codemirror.min.js',
        codeMirrorJSModeJS: '/echarts4/cdn/javascript.js',
        beautifierJS: '/echarts4/cdn/beautifier.min.js',
    },
