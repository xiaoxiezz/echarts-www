module.exports = {
    ...
    cdnThirdParty: {
        jquery: '/cdn/jquery2.2.4.min.js',
        jquery_1_11_3: '/cdn/jquery1.11.3.min.js',
        bootstrapCSS: '/cdn/bootstrap.min.css',
        bootstrapJS: '/cdn/bootstrap.min.js',
        lodash: '/cdn/index.min.js',
        perfectScrollbarJS: '/cdn/perfect-scrollbar.min.js',
        perfectScrollbarCSS: '/cdn/perfect-scrollbar.min.css',
        paceProgressBarJS: '/cdn/pace.min.js',
        sweetalertJS: '/cdn/sweetalert.min.js',
        echartsMinJS_4_8_0: '/cdn/echarts.min.js',
        prettifyJS: '/cdn/prettify.min.js',
        // Can not find good prettify css in jsdelivr.
        // prettifyCSS: '/cdn/doxy.css',
        prettifyCSSHandlerJS: '/cdn/lang-css.js',
        jqueryLazyloadJS: '/cdn/jquery.lazyload.min.js',

        // CDN for doc
        vueJS: '/cdn/vue.min.js',
        elementUIJS: '/cdn/index.js',
        elementUICSS: '/cdn/index.css',
        codeMirrorJS: '/cdn/codemirror.min.js',
        codeMirrorJSModeJS: '/cdn/javascript.js',
        beautifierJS: '/cdn/beautifier.min.js',
    },
