module.exports = {
    ...
    cdnThirdParty: {
        jquery: '/echarts5/cdn/jquery2.2.4.min.js',
        jquery_1_11_3: '/echarts5/cdn/jquery1.11.3.min.js',
        bootstrapCSS: '/echarts5/cdn/bootstrap.min.css',
        bootstrapJS: '/echarts5/cdn/bootstrap.min.js',
        lodash: '/echarts5/cdn/index.min.js',
        perfectScrollbarJS: '/echarts5/cdn/perfect-scrollbar.min.js',
        perfectScrollbarCSS: '/echarts5/cdn/perfect-scrollbar.min.css',
        paceProgressBarJS: '/echarts5/cdn/pace.min.js',
        sweetalertJS: '/echarts5/cdn/sweetalert.min.js',
        echartsMinJS_4_8_0: '/echarts5/cdn/echarts.min.js',
        prettifyJS: '/echarts5/cdn/prettify.min.js',
        // Can not find good prettify css in jsdelivr.
        // prettifyCSS: '/echarts5/cdn/doxy.css',
        prettifyCSSHandlerJS: '/echarts5/cdn/lang-css.js',
        jqueryLazyloadJS: '/echarts5/cdn/jquery.lazyload.min.js',

        // CDN for doc
        vueJS: '/echarts5/cdn/vue.min.js',
        elementUIJS: '/echarts5/cdn/index.js',
        elementUICSS: '/echarts5/cdn/index.css',
        codeMirrorJS: '/echarts5/cdn/codemirror.min.js',
        codeMirrorJSModeJS: '/echarts5/cdn/javascript.js',
        beautifierJS: '/echarts5/cdn/beautifier.min.js',
    },
